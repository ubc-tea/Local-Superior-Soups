...
num_clients = 5
num_classes = 10
ROOT_DIR = "/home/chenmh/projects/rrg-timsbc/chenmh/cmh_proj/dataset/fmnist/"
dir_path = ROOT_DIR
...
def generate_fmnist(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    check(config_path, train_path, test_path, num_clients, num_classes, niid, balance, partition)
